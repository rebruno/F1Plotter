...
class APIRequester:
    ...
    def __init__(self, debug = False):
        self.lastURLRequest = None #kind of a cache, useful for stuff like getting the racename without making another request
        self.debug = debug
    ...
    def driver(self, driverID):
        ...
        (e.g. Michael and Ralf Schumacher), their first name is prepended("michael_schumacher"). 
